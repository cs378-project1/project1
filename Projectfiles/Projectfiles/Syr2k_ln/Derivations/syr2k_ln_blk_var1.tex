...
\renewcommand{\afterupdate}{
	...
	\left(\begin{array}{c c c}
	A_0B_0^T + B_0A_0^T + \widehat C_{00} & * & * \\  
	A_1B_0^T + B_1A_0^T + \widehat  C_{10} & A_1B_1^T + B_1A_1^T + \widehat C_{11} & * \\ 
	\widehat C_{20} & \widehat C_{21} & \widehat C_{22}
	\end{array}\right)
 $}
...
$
  \begin{array}{l}          % do not delete this line 
    ...
    \mbox{$C_{10} :=  A_1B_0^T + B_1A_0^T + C_{10}$} % replace \mbox{...} with update line but leave \\
