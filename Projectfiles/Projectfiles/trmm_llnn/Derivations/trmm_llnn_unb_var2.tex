...
\renewcommand{\beforeupdate}{$ 
	...
	\widehat B_0 \\ 
	\widehat b_1^T \\  
	L_{20}\widehat B_0 + l_{21}\widehat b_1^T +   L_{22} \widehat B_2
	\end{array}\right) 
$}
...
\renewcommand{\afterupdate}{$ 
		...
		\left(\begin{array}{c}
		\widehat B_0 \\
		l_{10}^T \widehat B_0 + \lambda_{11} \widehat b_1^T \\  
		L_{20}B_0 + l_{21} b_1^T + L_{22} \widehat B_2
		\end{array}\right) 
	$}
...
\renewcommand{\update}{
	...
	b_1^T := l_{10}^T  B_0 + \lambda_{11} b_1^T 
